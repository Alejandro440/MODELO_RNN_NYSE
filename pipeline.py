...
STEPS = {
    "download-stocks": REPO_DIR / "0.1IMPORTACION_ARCHIVOS_ACCIONES.py",
    "preprocess-index": REPO_DIR / "0.PREPROCESAMIENTO_INDICE.py",
    "build-features": REPO_DIR / "1.CREACION_VARIABLES.py",
    "add-target": REPO_DIR / "2.VARIABLE_OBJETIVO(2).py",
    "merge-index": REPO_DIR / "3.INCOPORACION_DE_INDICE(2).py",
    "train-model": REPO_DIR / "MODELO15(3).py",
}
